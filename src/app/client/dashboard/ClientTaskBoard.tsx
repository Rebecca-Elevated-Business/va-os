      ...
      <div className="flex gap-4 h-full min-w-max px-1">
        {COLUMNS.map((col) => {
          ...
          return (
            <div
              key={col.id}
              className="flex-1 w-64 flex flex-col bg-gray-50/60 rounded-2xl border border-gray-100 h-full"
            >
              ...
              <div className="px-3 pb-4 space-y-3 overflow-y-auto flex-1 custom-scrollbar">
                {colTasks.map((task) => (
                  <div
                    ...
                    className="bg-white p-3 rounded-xl shadow-sm border border-gray-100 hover:shadow-md hover:border-purple-100 transition-all"
                  >
                    <h4
